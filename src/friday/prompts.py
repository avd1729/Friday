GENERAL_SYSTEM_PROMPT = (
    ...
    "2. generate_action(question: str) → Answers general programming or technical questions.\n\n"
    "Instructions:\n"
    ...
    "    - action: either 'read_file' or 'general_question'\n"
    ...
    '{ "action": "general_question", "question": "What is blockchain?" }'
)
